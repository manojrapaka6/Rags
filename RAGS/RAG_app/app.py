...
#title
st.title(":red RAG System : A context understand on Leave No Context Behind")
st.header("AI For Question & Answers ")

f = open(r"D:\RAGS\RAGS\KEY\gemini_key.txt")
KEY = f.read()
...
dat = PDFMinerLoader(r"D:\RAGS\RAGS\2404.07143.pdf")
dat_nik =dat.load()
